...
> Composio + OpenCLI unified stack — 3000+ SaaS actions + 90+ site adapters for complete zero-LLM business automation.
...
|---|---|---|
| [Composio-Openclaw Core](bin/) | `bin/` | Primary automation scripts and tools for hmz-composio-openclaw |
